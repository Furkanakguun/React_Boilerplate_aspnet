...
{
    public abstract class StudentInformationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static StudentInformationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(StudentInformationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<StudentInformationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<StudentInformationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<StudentInformationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<StudentInformationDbContext, Task<T>> func)
        {
            T result;
