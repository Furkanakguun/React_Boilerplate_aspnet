...
import { HomeOutlined, UserOutlined, TagsOutlined, AppstoreOutlined, InfoCircleOutlined,  UsergroupAddOutlined, BookFilled } from '@ant-design/icons';
...
export const appRouters: any = [
  ...
  },
  {
    ...
    showInMenu: true,
    component: LoadableComponent(() => import('../../scenes/Students')),
  },
  {
    path: '/course',
    name: 'Pages.Courses',
